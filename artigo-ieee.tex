...
%
In addition to collecting the \textbf{/proc/pid/numa\_maps} directory contents, a raw copy of the container's process memory was also acquired using the Linux \textit{GDB} utility and the \textit{nsenter} tool, via the following commands:
...
\textcolor{blue}{And figure \ref{fig:erro-copia-gdb} shows the content of the readable part of the memory at addresses \textbf{7fbb52a50000} where the library \textbf{libexample.so} simulating a library-based malware is allocated.
%
