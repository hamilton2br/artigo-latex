...
%
Este trabalho, com foco técnico, analisa propostas voltadas a resolver os desafios existentes na coleta de evidências na nuvem, discute suas limitações, e então apresenta uma solução visando suplantá-las.
%
...
%
O sistema foi então executado por 30 minutos, tempo durante o qual foram coletadas como métricas (1) o uso de espaço em disco utilizado pelos instantâneos de memória salvos, (2) o tempo de pausa no contêiner necessário para a cópia das mesmas e (3) o tempo de transporte da evidência para a máquina física fora da nuvem.
%
