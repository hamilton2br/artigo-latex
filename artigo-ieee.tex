...
\begin{figure*}[htb!]
\footnotesize
\caption{The two commands to generate a raw copy of the process container memory}
...
\textcolor{blue}{And figure \ref{fig:conteudo-memoria-copia-gdb} shows the content of the readable part of the memory at addresses \textbf{0x7f85633b9000} where \textbf{libexample.so} simulating a library-based malware is allocated.}
%
