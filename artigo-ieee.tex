...
\begin{figure}[htb!]
\footnotesize
\caption{\fancyname's general architecture. \marcos{Não precisa copiar 3x os mesmos blocos para explicar a solução... 1x basta... Hamilton: Era pra passar a ideia de que não é uma solução de coleta centralizada. Pelo seu comentário suspeito que fracassei em passar a ideia. E por favor (1) aumente a fonte do texto na figura Hamilton: Done e (2) crie uma imagem vetorizada em pdf (e.g., no Visio dá para exportar como pdf) Hamilton: Está vetorizado mas fiz no Corel e exporto como jpeg. PDF é melhor?}}
