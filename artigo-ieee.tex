...
One of the most pertinent parts of this work is the preservation of evidence, which must be collected so that they are accepted in a legal process and do not have their credibility questioned in the course of it.
%
To achieve this goal, we must ensure the evidence's chain of custody.
...
%
To limit the exposure of evidence it may be kept in a safe room, to which access is controlled.
%
The reproducibility of the collection process and the maintenance of the integrity of the evidence are then very straightforward tasks.
%
In a scenario of cloud computing, especially those of self-scalable infrastructure, there are a number of new challenges. 
%
First, in contrast with traditional infrastructures, the physical resource can not in principle be removed, those resources may contain information from users not related to the investigation in progress, doing so would constitute a violation of privacy. 
%
The volatility of the computational resource turns the verification of the evidence's origin a more complex process, because the resource that generates the evidence may cease to exist some time after the collection takes place \cite{Simou_Cloud_Chlng:2014}.
%
The integrity of the evidence also ends up being a non-trivial task, as it needs to be collected, transported and stored, which characterizes the need to preserve the chain of custody. 
%
