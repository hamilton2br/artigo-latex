...
The evidence-gathering process in digital forensics inherited its practices from the traditional forensics, where crime scene is isolated and evidence is collected.
%
...
%
Another limitation is that the framework depends on the cooperation of the cloud provider which is considered a weak strategy by the forensic community because the priority of CSP is to guarantee the availability of the service, not to collect evidence.
