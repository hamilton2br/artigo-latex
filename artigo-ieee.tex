...
A solução \fancyname foi configurada para realizar coletas de memória em intervalos de 1 minuto, salva-las em um armazenamento em disco externo e apagar aquelas que tivessem mais de 5 minutos de existência. 
%
...
%
A cada coleta executou-se o comando \texttt{du -sh *.mem} do \textit{Unix} no armazenamento externo para retornar a lista dos arquivos onde os instantâneos de memória foram armazenados e o espaço em disco ocupado pelos mesmos. 
%
...
Armazenando apenas os instantâneos de memória mostramos que é possível coletar informações da núvem sem uma cópia total da máquina assim não violando a privacidade dos não envolvidos na investigação.
%

Armazenando em um disco externo monstramos que é possível evitar problemas de jurisdição relacionadas a localização física de um armazenamento virtual caso os instantâneos permanecessem na nuvem.
%
