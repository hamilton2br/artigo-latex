...
% keywords
\begin{IEEEkeywords}
Cloud computing, containers, digital forensics, cloud forensics, evidence acquisition, chain of custody.
\end{IEEEkeywords}}
...
Aiming to improve the atomicity of a memory copy process, \fancyname\ temporarily interrupts the execution of the container, makes a copies of its contents, and then resumes its execution. 
%
