...
\begin{figure*}[htb!]
\caption{Lista de instantâneos de memória. \marcosT{Coloque fundo branco e texto em preto (ou outra cor escura): melhora a visibilidade. Também precisa aumentar a fonte, e, potencialmente, fazer highlight de alguma coisa (para o leitor, parece um monte de caracteres aleatórios...). Se precisar de espaço, pode colocar como ``figure*'', para que a imagem ocupe as duas colunas do documento - Hamilton: Feito.}}
...
%
Instâncias de processamento virtual, que foram vítimas de ameaças que atuam diretamente na memória sem deixar rastros em disco, quando desalocadas não deixam evidencias para suportar uma investigação. Combinado com os aspectos multi inquilino e multi jurisdição das soluções em núvem, dificulta a coleta de informações para a investigação de incidentes.
%
