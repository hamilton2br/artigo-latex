...
Como trabalho futuro, pretende-se estudar o impacto provocado pela pausa do contêiner no desempenho de um sistema em produção e realizar uma análise da memória dos contêiners deste mesmo sistema utilizando as coletas feitas por \fancyname. Com esses resultados pretende-se implementar uma ferramenta mais flexível que não precise ter acesso a memória completa da máquina, requisito comum de muitas ferramentas de análise de malware no mercado (e.g., FROST \cite{Dykstra_FROST:2013} e Volatility Framework \cite{VolatilityFoundation2014}).
