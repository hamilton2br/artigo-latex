...
%
This paper analyzes proposals in the literature to solve the main challenges on collecting evidence in the cloud, its limitations and then proposes a solution to collect, transport and storage the evidence in order to supplant them. 
%
